...
from ml_mdm.models.mlx_model_ema import ModelEmaMLX
...
def test_pytorch_mlp():
    ...
    pytorch_mlp = ModelEma(channels=channels, multiplier=multiplier)
    mlx_mlp = ModelEmaMLX(channels=channels, multiplier=multiplier)
